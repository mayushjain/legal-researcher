...
export interface GPTResearcherProps {
  apiUrl?: string;
  /** Google Gemini API key for LLM and optional image generation */
  apiKey?: string;
...
export const GPTResearcher = ({
  ...
  const handleDisplayResult = async (newQuestion: string) => {
    ...
    // Use provided apiKey if available (Google Gemini API key)
    if (apiKey) {
      apiVariables.GOOGLE_API_KEY = apiKey;
      apiVariables.GEMINI_API_KEY = apiKey;
    }
